...
const fieldUpdates = [
  ...
  },
  {
    ...
    category: 'Classification / Payroll / Rating',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'Total number of employees assigned to this specific workers compensation class code (full-time + part-time + seasonal if applicable).',
    extractorLogic: 'Files: WC apps, supplemental questionnaires, class code schedules, payroll summaries. Where: Near class code rows, payroll per class tables, employee schedules. Other Terms: "# Employees", "Headcount", "Total Employees", "Emp Count", "No. of Workers". Example Values: 3, 12, 47. Default Value: 0 (if missing).',
    whereToLook: 'WC Application, Supplemental Application, Payroll Summary, Employee Schedule',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  {
    ...
    category: 'Classification / Payroll / Rating',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'Number of full-time employees for the class code (typically working ≥30 hours/week).',
    extractorLogic: 'Files: WC applications, employee schedules, payroll summaries. Where: Class code tables, payroll breakdown sections. Other Terms: "FT employees", "Full-time count", "FT headcount". Example Values: 2, 8, 95. Default Value: 0.',
  ...
  },
  {
    ...
    category: 'Classification / Payroll / Rating',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'Number of part-time employees for the class code (typically <30 hours/week).',
    extractorLogic: 'Files: WC app, payroll summary, employee detail lists. Where: In class code table lines, near FT employee counts. Other Terms: "PT employees", "Part time count", "Seasonal employees" (sometimes merged). Example Values: 1, 3, 10. Default Value: 0.',
    whereToLook: 'WC Application, Payroll Summary, Employee Schedule',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  {
    ...
    category: 'Classification / Payroll / Rating',
    fieldType: 'string' as FieldValueType,
    businessDescription: 'Describes the nature of work within the class (e.g., clerical, outside sales, manufacturing, drivers).',
    extractorLogic: 'Files: WC app, job descriptions, supplemental forms. Where: Class code description lines, job duty sections. Other Terms: "Work Type", "Job Category", "Occupation Type", "Role Type". Example Values: "Clerical", "Outside Sales", "Machine Operators", "Warehouse". Default Value: null.',
    whereToLook: 'WC Application, Supplemental Application, Job Descriptions',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  {
    ...
    category: 'Classification / Payroll / Rating',
    fieldType: 'string' as FieldValueType,
    businessDescription: 'Narrative description of the job duties for the class code (e.g., "office clerical operations", "light assembly", "drivers delivering goods").',
    extractorLogic: 'Files: WC app, OSHA logs, supplemental apps, job descriptions. Where: Next to class code numbers or in free-text job description fields. Other Terms: "Job Description", "Duties", "Operations description", "Class detail". Example Values: "Clerical office staff", "Drivers delivering packages", "Light manufacturing". Default Value: null.',
    whereToLook: 'WC Application, Supplemental Application, Job Descriptions',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  ...
  },
  {
    ...
    category: 'Payroll & Exposure Attachments',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'Estimated total payroll for all classes and locations combined, used for WC premium calculation.',
    extractorLogic: 'Files: WC application, payroll summary, accountant statements. Where: Payroll tables, total exposure summaries. Other Terms: "Est. Annual Payroll", "Projected Payroll", "Estimated Wages", "Annual Payroll Total". Example Values: 450000, 1,200,000. Default Value: 0.',
    whereToLook: 'WC Application, Payroll Summary, Financial Statements',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  {
    ...
    category: 'Payroll & Exposure Attachments',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'Total number of employees across all locations and classes.',
    extractorLogic: 'Files: WC app, payroll summary, employee lists. Where: Totals row in schedules; sometimes appears only in narrative sections. Other Terms: "Total Employees", "Total Headcount", "Company Headcount". Example Values: 12, 34, 105. Default Value: 0.',
    whereToLook: 'WC Application, Payroll Summary, Employee Schedule',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  {
    ...
    category: 'Payroll & Exposure Attachments',
    fieldType: 'string' as FieldValueType,
    businessDescription: 'Indicates whether the payroll is estimated, actual, audited, or other basis used for rating.',
    extractorLogic: 'Files: WC application, audits, prior carrier declarations. Where: Payroll exposure section, audit history notes. Other Terms: "Basis: Estimated/Actual/Audited", "Projected vs Actual payroll", "Rating basis". Example Values: "Estimated", "Actual", "Audited". Default Value: "Estimated".',
    whereToLook: 'WC Application, Audit Documents, Prior Declarations',
    inAcord130: 'Yes',
    whereInAcord130: 'N/A',
  },
  ...
  },
  {
    ...
    category: 'Prior Carrier & Loss History',
    fieldType: 'decimal' as FieldValueType,
    businessDescription: 'Experience Modification Factor (mod) applied to premium (e.g., 0.92, 1.13).',
    extractorLogic: 'If an NCCI mod worksheet is attached, extract the final mod ("Final Mod: 0.87"). If the submission email states "Current mod is 1.14", use that. Loss runs often list mod for each year — use the most recent unless asked otherwise.',
    whereToLook: 'NCCI Experience Mod Worksheet (PDF), Dec pages or renewal summaries, Loss runs, Submission email.',
    inAcord130: 'Yes',
    whereInAcord130: '"PRIOR CARRIER INFORMATION" table, EXPERIENCE MOD column.',
  },
  {
  ...
  },
  {
    ...
    businessDescription: 'The date the accident/injury occurred.',
    extractorLogic: 'Extract from "Date of Loss" column. Normalize to ISO date YYYY-MM-DD.',
    whereToLook: 'Loss runs.',
    inAcord130: 'Yes',
    whereInAcord130: 'Loss attachment.',
  },
  ...
  },
  {
    ...
    category: 'Individuals Included / Excluded',
    fieldType: 'string' as FieldValueType,
    businessDescription: 'The full name of the officer/owner/partner/member.',
    extractorLogic: 'Extract name exactly from Officer/Owner table in supplemental. If not listed, pull from attached "Officers schedule" Excel. Use full legal name (no abbreviations unless that\'s how it appears).',
    whereToLook: 'WC supplemental, Attached Excel ("Officer schedule", "Ownership roster").',
    inAcord130: 'Yes',
    whereInAcord130: 'Page 1 – "INDIVIDUALS INCLUDED / EXCLUDED", NAME column.',
  },
  {
    fieldName: 'individualTitle',
    category: 'Individuals Included / Excluded',
    fieldType: 'string' as FieldValueType,
    businessDescription: 'Title or role (e.g., CEO, Managing Partner, Owner, Member, Director).',
    extractorLogic: 'Extract from officer schedule or supplemental row. If missing, extract from submission email signature block if the officer wrote the email. Titles must not be invented — use only supplied text.',
    whereToLook: 'WC supplemental, Officer schedule Excel, Submission email.',
    inAcord130: 'Yes',
    whereInAcord130: 'Page 1 officer section, TITLE column.',
  },
  {
    fieldName: 'individualOwnershipPercent',
    category: 'Individuals Included / Excluded',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'Percentage of company ownership held by the individual (used by states to determine WC inclusion requirements).',
    extractorLogic: 'Extract numeric % from officer schedule or supplemental ("John Smith – 60%"). Convert fractions into percentages if needed ("⅓ owner" → ~33%). If not provided, leave null — do not guess.',
    whereToLook: 'WC supplemental – ownership section, Officer roster/Cap table summary.',
    inAcord130: 'Yes',
    whereInAcord130: 'Page 1 officer table, % OWNERSHIP column.',
  },
  {
  ...
  },
  {
    ...
    category: 'Individuals Included / Excluded',
    fieldType: 'text' as FieldValueType,
    businessDescription: 'Description of the actual job duties performed by the officer/owner.',
    extractorLogic: 'Extract from officer table (e.g., "Management only", "Field supervision", "Sales"). If missing, correlate with job title + operations narrative: CEO/Admin → Clerical/Administrative, Field Manager → Field/Operational. Do not produce duties outside what the documents imply.',
    whereToLook: 'WC supplemental "Individuals included/excluded" table, Operations narrative, Organizational chart (if attached).',
    inAcord130: 'Yes',
    whereInAcord130: 'Page 1 – officer section, DUTIES column.',
  },
  {
    fieldName: 'individualIncludeOrExcludeWC',
    category: 'Individuals Included / Excluded',
    fieldType: 'string' as FieldValueType,
    businessDescription: 'Flag indicating whether the individual opts to be covered by WC (INCLUDE) or opts out (EXCLUDE), per state statutes.',
    extractorLogic: 'Extract directly from officer schedule ("Include", "Exclude"). If the supplemental says "All officers excluded by state rule," mark accordingly. If not indicated, default to null — inclusion cannot be assumed.',
    whereToLook: 'WC supplemental, Officer schedule Excel, Prior policy dec pages.',
    inAcord130: 'Yes',
    whereInAcord130: 'Page 1 – officer table, INCL / EXCL checkbox column.',
  },
  {
  ...
  },
  {
    ...
    category: 'Individuals Included / Excluded',
    fieldType: 'number' as FieldValueType,
    businessDescription: 'The payroll amount assigned to the officer for WC rating (subject to state minimums/maximums, but Autos should not enforce those).',
    extractorLogic: 'Extract payroll values from officer schedule or supplemental. If payroll provided in ranges ("Paid between $50k–$70k"), store the number given or median if explicit number missing; otherwise store the text. If only total officer payroll is listed, split only if amounts per officer are given — otherwise leave null.',
    whereToLook: 'Officer schedule Excel, WC supplemental – "Officers" section, Prior audit reports (sometimes show officer payrolls).',
    inAcord130: 'Yes',
